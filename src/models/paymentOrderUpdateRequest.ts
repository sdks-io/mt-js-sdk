...
import { Status18, status18Schema } from './status18.js';
...
export const paymentOrderUpdateRequestSchema: Schema<PaymentOrderUpdateRequest> = lazy(
  () =>
    typedExpandoObject(
      {
        ...
        direction: ['direction', optional(direction5Schema)],
        ...
        status: ['status', optional(status18Schema)],
