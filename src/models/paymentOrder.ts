...
import {
  ...
  receivingAccountTypeEnumSchema,
} from './receivingAccountTypeEnum.js';
...
export interface PaymentOrder {
  ...
  receivingAccountType: ReceivingAccountTypeEnum;
...
export const paymentOrderSchema: Schema<PaymentOrder> = lazy(() =>
  object({
    ...
    subtype: ['subtype', nullable(subtypeEnumSchema)],
    amount: ['amount', number()],
    direction: ['direction', direction5EnumSchema],
    priority: ['priority', priorityEnumSchema],
    ...
    chargeBearer: ['charge_bearer', nullable(chargeBearerEnumSchema)],
    foreignExchangeIndicator: [
      'foreign_exchange_indicator',
      nullable(foreignExchangeIndicatorEnumSchema),
    ],
