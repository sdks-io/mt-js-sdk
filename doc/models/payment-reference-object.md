...
| `referenceableType` | [`ReferenceableTypeEnum`](../../doc/models/referenceable-type-enum.md) | Required | One of the referenceable types. This must be accompanied by the id of the referenceable or will return an error. |
| `referenceNumber` | `string` | Required | The actual reference number assigned by the bank. |
| `referenceNumberType` | [`ReferenceNumberType1Enum`](../../doc/models/reference-number-type-1-enum.md) | Required | The type of reference number. |
