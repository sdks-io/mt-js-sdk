...
| `status` | [`Status15Enum \| undefined`](../../doc/models/status-15-enum.md) | Optional | Status of the reversal ledger transaction. It defaults to `posted` if not provided. |
...
| `ledgerableType` | [`LedgerableType5Enum \| undefined`](../../doc/models/ledgerable-type-5-enum.md) | Optional | Specify this if you'd like to link the reversal ledger transaction to a Payment object like Return or Reversal. |
