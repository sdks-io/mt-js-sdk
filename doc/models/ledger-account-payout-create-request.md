...
| `status` | [`Status8 \| null \| undefined`](../../doc/models/status-8.md) | Optional | The status of the ledger account payout. It is set to `pending` by default. To post a ledger account payout at creation, use `posted`. |
