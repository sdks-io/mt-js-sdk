...
| `ledgerableType` | [`LedgerableTypeEnum \| undefined`](../../doc/models/ledgerable-type-enum.md) | Optional | If the ledger account links to another object in Modern Treasury, the type will be populated here, otherwise null. The value is one of internal_account or external_account. |
