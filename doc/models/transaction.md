...
| `vendorCodeType` | [`VendorCodeType1 \| null`](../../doc/models/vendor-code-type-1.md) | Required | The type of `vendor_code` being reported. Can be one of `bai2`, `bankprov`, `bnk_dev`, `cleartouch`, `currencycloud`, `cross_river`, `dc_bank`, `dwolla`, `evolve`, `goldman_sachs`, `iso20022`, `jpmc`, `mx`, `signet`, `silvergate`, `swift`, or `us_bank`. |
...
| `type` | [`Type11`](../../doc/models/type-11.md) | Required | The type of the transaction. Can be one of `ach`, `wire`, `check`, `rtp`, `book`, or `sen`. |
