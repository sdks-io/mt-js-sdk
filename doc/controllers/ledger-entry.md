...
| `status` | [`Status23 \| undefined`](../../doc/models/status-23.md) | Query, Optional | Get all ledger entries that match the status specified. One of `pending`, `posted`, or `archived`. |
