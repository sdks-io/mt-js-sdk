...
| `status` | [`Status22 \| undefined`](../../doc/models/status-22.md) | Query, Optional | The current status of the incoming payment order. One of `pending`, `completed`, or `returned`. |
