...
| `body` | [`InvoiceCreateRequest \| undefined`](../../doc/models/invoice-create-request.md) | Body, Optional | - |
...
|  --- | --- | --- | --- |
| `id` | `string` | Template, Required | id |
| `body` | [`InvoiceUpdateRequest \| undefined`](../../doc/models/invoice-update-request.md) | Body, Optional | - |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |
